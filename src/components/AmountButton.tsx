...
const getBackground = (amount: number | 'custom') => {
  ...
  const colorMap: { [key: number]: string } = {
    2: backgroundR2,  // Copper (R2 coin)
    5: backgroundR5,  // Silver (R5 coin)
    10: backgroundR10,  // Dark gold (R10 coin)
    20: backgroundR20, // Saddle brown (R20 note)
    50: backgroundR50, // Crimson (R50 note)
    100: backgroundR100, // Royal blue (R100 note)
    200: backgroundR200, // Dark orange (R200 note)
  };
